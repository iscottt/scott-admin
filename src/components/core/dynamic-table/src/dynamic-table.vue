...
import { useTableMethods, createTableContext, useTableForm, useTableState } from './hooks';
...
const { getColumnKey, fetchData, queryTable, reload, handleTableChange, getComponent } = tableMethods;
