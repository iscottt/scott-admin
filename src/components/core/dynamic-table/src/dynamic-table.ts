...
export const dynamicTableProps = {
  ...
  dataRequest: {
    ...
    type: Function as PropType<
      (params?: LoadDataParams, onChangeParams?: OnChangeCallbackParams) => Promise<API.TableListResult>
    >,
  },
  /** 是否显示索引号 */
  showIndex: {
  ...
  /** 自定义数据导出格式函数 */
  exportFormatter: {
    type: Function as PropType<(columns: TableColumn<any>[], tableData: any[]) => { header: string[]; data: any[] }>,
    default: null,
  },
} as const;
