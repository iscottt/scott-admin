  ...
  actions: {
    ...
    async initDynamicRoute(router: Router) {
      ...
      if (retData) {
        ...
        this.searchMenus = transformAuthRoutesToSearchMenus(retData.routes);

        const vueRoutes = transformAuthRoutesToVueRoutes(retData.routes);
        ...
        initHomeTab(retData.home, router);
